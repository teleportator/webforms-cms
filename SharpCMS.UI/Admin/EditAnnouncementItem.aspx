<%@ Page Language="C#" MasterPageFile="~/Shared/Master/admin.Master" AutoEventWireup="true"
         CodeBehind="EditAnnouncementItem.aspx.cs" Inherits="SharpCMS.UI.Admin.EditAnnouncementItemPage" %>
    ...
    <div class="editor-menu">
    	<ul>
            <li class="editor-menu-item">
            	<asp:LinkButton runat="server" ID="btnSaveAnnouncementItem" CssClass="editor-menu-item-link"
                    onclick="btnSaveAnnouncementItem_Click" ><span>Сохранить</span></asp:LinkButton>
            </li>
            <li class="editor-menu-item">
    ...
    <table class="item-details">
        ...
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtAnnouncementItemTitle" CssClass="item-details-property" Width="400px"
                    MaxLength="200" />
        ...
        <tr>
        	<td>
                ...
                <asp:CompareValidator runat="server" ID="valAnnouncementItemStartingDateType" Type="Date"
                    CssClass="input-error" ControlToValidate="txtAnnouncementItemStartingDate" Display="Dynamic"
                    Text="Не верный формат даты" Operator="DataTypeCheck" />
        	</td>
        </tr>
        <tr>
        	<td>
                ...
                <asp:CompareValidator runat="server" ID="valAnnouncementItemExpiryDateComparer" CssClass="input-error"
                    ControlToValidate="txtAnnouncementItemExpiryDate" Display="Dynamic" Type="Date"
        ...
        <tr>
        	<td>
                ...
                <asp:RequiredFieldValidator runat="server" ID="valAnnouncementItemContact" CssClass="input-error"
                    ControlToValidate="txtAnnouncementItemStartingTime" Display="Dynamic" Text="Введите контактную информацию." />
        	</td>
        </tr>
        <tr>
        	<td>
        ...
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtAnnouncementItemSortOrder" CssClass="item-details-property"
                    Width="400px" />
