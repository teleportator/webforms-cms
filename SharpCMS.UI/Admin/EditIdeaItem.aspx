<%@ Page Language="C#" MasterPageFile="~/Shared/Master/admin.Master" AutoEventWireup="true" CodeBehind="EditIdeaItem.aspx.cs"
         Inherits="SharpCMS.UI.Admin.EditIdeaItem" %>
    ...
    <div class="editor-menu">
    	<ul>
            <li class="editor-menu-item">
            	<asp:LinkButton runat="server" ID="btnSaveIdeaItem" CssClass="editor-menu-item-link"
                    onclick="btnSaveIdeaItem_Click" ><span>Сохранить</span></asp:LinkButton>
            </li>
            <li class="editor-menu-item">
    ...
    <table class="item-details">
        ...
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtIdeaItemSortOrder" CssClass="item-details-property" Width="400px" />
