<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Master/admin.Master" AutoEventWireup="true"
         CodeBehind="EditHomePage.aspx.cs" Inherits="SharpCMS.UI.Admin.EditHomePage" %>
...
<asp:Content ID="RightContent" ContentPlaceHolderID="RightPlaceHolder" runat="server">
    <table class="item-details">
        ...
        <tr>
        	<td>
        		<asp:CheckBox runat="server" ID="chkArticleIsActive" CssClass="item-details-property" Text="Показывать на сайте" />
        	</td>
        </tr>
        <tr>
        	<td>
        ...
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtArticleSortOrder" CssClass="item-details-property" Width="400px" />
        ...
        <tr>
        	<td>
        		<asp:CheckBox runat="server" ID="chkArticleDisplayOnMainMenu" CssClass="item-details-property"
                    Text="Показывать в главном меню" Enabled="false" />
        	</td>
        </tr>
        <tr>
        	<td>
