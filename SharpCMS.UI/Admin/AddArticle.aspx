<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddArticle.aspx.cs" Inherits="SharpCMS.UI.Admin.AddArticlePage"
    ...
    <div class="editor-menu">
    	<ul>
            <li class="editor-menu-item">
            	<asp:LinkButton runat="server" ID="btnCreateArticle" CssClass="editor-menu-item-link" 
                    onclick="btnCreateArticle_Click"><span>Сохранить</span></asp:LinkButton>
            </li>
            <li class="editor-menu-item">
    ...
    <table class="item-details">
        ...
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtArticleTitle" CssClass="item-details-property" Text="Новый раздел"
                    Width="400px" MaxLength="200" />
                <span class="item-details-sublabel">Максимум 200 символов</span>
                <asp:RequiredFieldValidator runat="server" ID="valArticleTitleRequired" CssClass="input-error"
                    ControlToValidate="txtArticleTitle" Display="Dynamic" Text="Введите заголовок" />
        	</td>
        </tr>
        <tr>
        	<td>
        ...
        <tr>
        	<td>
        		<asp:CheckBox runat="server" ID="chkArticleDisplayOnSideMenu" CssClass="item-details-property"
                    Text="Показывать в боковом меню" Checked="true" Enabled="false" />
        	</td>
        </tr>
    </table>
</asp:Content>