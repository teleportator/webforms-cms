<%@ Page Language="C#" MasterPageFile="~/Shared/Master/admin.Master" AutoEventWireup="true"
         CodeBehind="AddCompanyItem.aspx.cs" Inherits="SharpCMS.UI.Admin.AddCompanyItem" %>
    ...
    <table class="item-details">
        ...
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtСompanyItemTitle" CssClass="item-details-property" Text="Новый элемент"
        ...
        <tr>
        	<td>
        		...
        		<sharp:ImageUploader runat="server" ID="iupCompanyLogo" ImageWidth="150" CurrentImagePath=""
        ...
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtCompanyItemSortOrder" CssClass="item-details-property" Text="500"
                    Width="400px" />
