<%@ Page Language="C#" MasterPageFile="~/Shared/Master/admin.Master" AutoEventWireup="true"
         CodeBehind="EditNewsItem.aspx.cs" Inherits="SharpCMS.UI.Admin.EditNewsItemPage" %>
    ...
    <div class="editor-menu">
    	<ul>
            <li class="editor-menu-item">
            	<asp:LinkButton runat="server" ID="btnSaveNewsItem" CssClass="editor-menu-item-link"
                    onclick="btnSaveNewsItem_Click" ><span>Сохранить</span></asp:LinkButton>
            </li>
            <li class="editor-menu-item">
    ...
    <table class="item-details">
        ...
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtNewsItemTitle" CssClass="item-details-property"
        ...
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtNewsItemKeywords" CssClass="item-details-property" Width="400px"
                    MaxLength="200" />
                <span class="item-details-sublabel">Максимум 200 символов</span>
            </td>
        </tr>
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtNewsItemDescription" CssClass="item-details-property" Width="400px"
                    MaxLength="200" />
                <span class="item-details-sublabel">Максимум 200 символов</span>
        	</td>
        </tr>
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtNewsItemSortOrder" CssClass="item-details-property" Width="400px" />
