<%@ Page Language="C#" MasterPageFile="~/Shared/Master/admin.Master" AutoEventWireup="true"
         CodeBehind="AddVacancyItem.aspx.cs" Inherits="SharpCMS.UI.Admin.AddVacancyItemPage" %>
    ...
    <div class="editor-menu">
    	<ul>
            <li class="editor-menu-item">
            	<asp:LinkButton runat="server" ID="btnCreateVacancyItem" CssClass="editor-menu-item-link"
                    onclick="btnCreateVacancyItem_Click"><span>Сохранить</span></asp:LinkButton>
            </li>
            <li class="editor-menu-item">
    ...
    <table class="item-details">
        ...
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtVacancyItemTitle" CssClass="item-details-property" Text="Новый элемент"
        ...
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtVacancyItemDescription" CssClass="item-details-property"
                    Width="400px" MaxLength="200" />
                <span class="item-details-sublabel">Максимум 200 символов</span>
        	</td>
        </tr>
        <tr>
        	<td>
        		...
        		<asp:TextBox runat="server" ID="txtVacancyItemSortOrder" CssClass="item-details-property" Text="500"
                    Width="400px" />
