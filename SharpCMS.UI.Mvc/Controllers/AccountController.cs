...
using SharpCMS.UI.Mvc.Models.Accounts;
...
namespace SharpCMS.UI.Mvc.Controllers
{
    public class AccountController : ControllerBase
    {
        ...
        public ActionResult LogOn(LogOnModel model, string returnUrl)
        {
            ...
            {
                string login = Membership.GetUserNameByEmail(model.Email);
                ...
                ModelState.AddModelError(String.Empty, "Адрес электронной почты или пароль указаны неверно.");
            }
